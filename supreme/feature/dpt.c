/* Generated by Cython 0.11.3 on Mon Apr  5 02:13:40 2010 */
...
/* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":60
 *         return -x
 * 
...
/* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":24
...
static  PyObject *__pyx_f_7supreme_7feature_3dpt_add_f_array(PyArrayObject *__pyx_v_a, __pyx_t_5numpy_float64_t __pyx_v_value, struct __pyx_obj_7supreme_3lib_3dpt_16connected_region_ConnectedRegion *__pyx_v_cr) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":28
 * 
 *     """
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":29
 *     """
 *     cdef np.ndarray[np.float64_t, ndim=2] arr = a
 *     cdef int rows = arr.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int cols = arr.shape[1]
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":30
 *     cdef np.ndarray[np.float64_t, ndim=2] arr = a
 *     cdef int rows = arr.shape[0]
 *     cdef int cols = arr.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":32
 *     cdef int cols = arr.shape[1]
 * 
 *     cdef int* rowptr = cr.rowptr.buf             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":33
 * 
 *     cdef int* rowptr = cr.rowptr.buf
 *     cdef int* colptr = cr.colptr.buf             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":35
 *     cdef int* colptr = cr.colptr.buf
 * 
 *     cdef int r, c, start, end, k, start_row = cr._start_row             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":37
 *     cdef int r, c, start, end, k, start_row = cr._start_row
 * 
 *     for r in range(cr.rowptr.size - 1):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":38
 * 
 *     for r in range(cr.rowptr.size - 1):
 *         for c in range((rowptr[r + 1] - rowptr[r]) / 2):             # <<<<<<<<<<<<<<
 *             start = colptr[rowptr[r] + 2*c]
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":39
 *     for r in range(cr.rowptr.size - 1):
 *         for c in range((rowptr[r + 1] - rowptr[r]) / 2):
 *             start = colptr[rowptr[r] + 2*c]             # <<<<<<<<<<<<<<
 *             end = colptr[rowptr[r] + 2*c + 1]
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":40
 *         for c in range((rowptr[r + 1] - rowptr[r]) / 2):
 *             start = colptr[rowptr[r] + 2*c]
 *             end = colptr[rowptr[r] + 2*c + 1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":42
 *             end = colptr[rowptr[r] + 2*c + 1]
 * 
 *             for k in range(start, end):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_6 = __pyx_v_start; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":43
 * 
 *             for k in range(start, end):
 *                 if r >= 0 and r < rows and \             # <<<<<<<<<<<<<<
 *                    start >= 0 and start < cols and \
 ...
 */
        if ((__pyx_v_r >= 0)) {
          if ((__pyx_v_r < __pyx_v_rows)) {
            ...
            /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":44
 *             for k in range(start, end):
 *                 if r >= 0 and r < rows and \
 *                    start >= 0 and start < cols and \             # <<<<<<<<<<<<<<
 *                    end >= 0 and end <= cols:
 ...
 */
            if ((__pyx_v_start >= 0)) {
              if ((__pyx_v_start < __pyx_v_cols)) {
                ...
                /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":45
 *                 if r >= 0 and r < rows and \
 *                    start >= 0 and start < cols and \
 *                    end >= 0 and end <= cols:             # <<<<<<<<<<<<<<
 *                     arr[r + start_row, k] += value
 ...
 */
        ...
        if (__pyx_t_7) {
          ...
          /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":46
 *                    start >= 0 and start < cols and \
 *                    end >= 0 and end <= cols:
 *                     arr[r + start_row, k] += value             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":48
 *                     arr[r + start_row, k] += value
 * 
 * cdef int iabs(int x):             # <<<<<<<<<<<<<<
 *     if x >= 0:
...
static  int __pyx_f_7supreme_7feature_3dpt_iabs(int __pyx_v_x) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":49
 * 
 * cdef int iabs(int x):
 *     if x >= 0:             # <<<<<<<<<<<<<<
 *         return x
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":50
 * cdef int iabs(int x):
 *     if x >= 0:
 *         return x             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":52
 *         return x
 *     else:
 *         return -x             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":54
 *         return -x
 * 
 * cdef np.double_t dabs(np.double_t x):             # <<<<<<<<<<<<<<
 *     if x >= 0:
...
static  __pyx_t_5numpy_double_t __pyx_f_7supreme_7feature_3dpt_dabs(__pyx_t_5numpy_double_t __pyx_v_x) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":55
 * 
 * cdef np.double_t dabs(np.double_t x):
 *     if x >= 0:             # <<<<<<<<<<<<<<
 *         return x
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":56
 * cdef np.double_t dabs(np.double_t x):
 *     if x >= 0:
 *         return x             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":58
 *         return x
 *     else:
 *         return -x             # <<<<<<<<<<<<<<
 * 
...
static  PyObject *__pyx_f_7supreme_7feature_3dpt_features(PyObject *__pyx_v_pulses, PyObject *__pyx_v_shape, int __pyx_skip_dispatch, struct __pyx_opt_args_7supreme_7feature_3dpt_features *__pyx_optional_args) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":93
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":94
 *     cdef int hwin
 *     cdef np.ndarray[np.double_t, ndim=2] weight = np.zeros(shape, dtype=float)
 *     cdef np.ndarray[np.int_t, ndim=2] area = np.zeros(shape, dtype=np.int)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=2] strength = np.zeros(shape, dtype=np.int)
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":95
 *     cdef np.ndarray[np.double_t, ndim=2] weight = np.zeros(shape, dtype=float)
 *     cdef np.ndarray[np.int_t, ndim=2] area = np.zeros(shape, dtype=np.int)
 *     cdef np.ndarray[np.int_t, ndim=2] strength = np.zeros(shape, dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":97
 *     cdef np.ndarray[np.int_t, ndim=2] strength = np.zeros(shape, dtype=np.int)
 * 
 *     for nnz in sorted(pulses):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (;;) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":98
 * 
 *     for nnz in sorted(pulses):
 *         for cr in pulses[nnz]:             # <<<<<<<<<<<<<<
 *             if nnz < max_area:
 ...
 */
    ...
    for (;;) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":99
 *     for nnz in sorted(pulses):
 *         for cr in pulses[nnz]:
 *             if nnz < max_area:             # <<<<<<<<<<<<<<
 *                 add_f_array(weight, iabs(cr._value) / pow(<double>cr._nnz, 0.5),
 ...
 */
      ...
      if (__pyx_t_12) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":100
 *         for cr in pulses[nnz]:
 *             if nnz < max_area:
 *                 add_f_array(weight, iabs(cr._value) / pow(<double>cr._nnz, 0.5),             # <<<<<<<<<<<<<<
 *                             cr)
 ...
 */
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":101
 *             if nnz < max_area:
 *                 add_f_array(weight, iabs(cr._value) / pow(<double>cr._nnz, 0.5),
 *                             cr)             # <<<<<<<<<<<<<<
 *                 crh._set_array(<np.int_t*>area.data,
 ...
 */
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":103
 *                             cr)
 *                 crh._set_array(<np.int_t*>area.data,
 *                                shape[0], shape[1], cr,             # <<<<<<<<<<<<<<
 *                                cr._nnz, 1)
 ...
 */
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":104
 *                 crh._set_array(<np.int_t*>area.data,
 *                                shape[0], shape[1], cr,
 *                                cr._nnz, 1)             # <<<<<<<<<<<<<<
 *                 crh._set_array(<np.int_t*>strength.data,
 ...
 */
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":106
 *                                cr._nnz, 1)
 *                 crh._set_array(<np.int_t*>strength.data,
 *                                shape[0], shape[1], cr,             # <<<<<<<<<<<<<<
 *                                1, 1)
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":109
 *                                1, 1)
 * 
 *     weight -= weight.min()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":111
 *     weight -= weight.min()
 * 
 *     hwin = (win_size - 1) / 2             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":112
 * 
 *     hwin = (win_size - 1) / 2
 *     for i in range(shape[0]):             # <<<<<<<<<<<<<<
 *         for j in range(shape[1]):
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_19; __pyx_t_10+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":113
 *     hwin = (win_size - 1) / 2
 *     for i in range(shape[0]):
 *         for j in range(shape[1]):             # <<<<<<<<<<<<<<
 *             # Filter peak, based on surrounding values
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_20; __pyx_t_14+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":115
 *         for j in range(shape[1]):
 *             # Filter peak, based on surrounding values
 *             for ii in range(i - hwin, i + hwin + 1):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_22 = (__pyx_v_i - __pyx_v_hwin); __pyx_t_22 < __pyx_t_21; __pyx_t_22+=1) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":116
 *             # Filter peak, based on surrounding values
 *             for ii in range(i - hwin, i + hwin + 1):
 *                 for jj in range(j - hwin, j + hwin + 1):             # <<<<<<<<<<<<<<
 *                     if (ii <= 0) or (ii >= shape[0]) or \
 ...
 */
        ...
        for (__pyx_t_24 = (__pyx_v_j - __pyx_v_hwin); __pyx_t_24 < __pyx_t_23; __pyx_t_24+=1) {
          ...
          /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":117
 *             for ii in range(i - hwin, i + hwin + 1):
 *                 for jj in range(j - hwin, j + hwin + 1):
 *                     if (ii <= 0) or (ii >= shape[0]) or \             # <<<<<<<<<<<<<<
 *                        (jj <= 0) or (jj >= shape[1]):
 ...
 */
          ...
          if (!__pyx_t_12) {
            ...
            if (!__pyx_t_25) {
              ...
              /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":118
 *                 for jj in range(j - hwin, j + hwin + 1):
 *                     if (ii <= 0) or (ii >= shape[0]) or \
 *                        (jj <= 0) or (jj >= shape[1]):             # <<<<<<<<<<<<<<
 *                         continue
 ...
 */
          ...
          if (__pyx_t_25) {
            ...
            /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":119
 *                     if (ii <= 0) or (ii >= shape[0]) or \
 *                        (jj <= 0) or (jj >= shape[1]):
 *                         continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":121
 *                         continue
 * 
 *                     if weight[ii, jj] > weight[i, j]:             # <<<<<<<<<<<<<<
 *                         weight[i, j] = 0
 ...
 */
          ...
          if (__pyx_t_25) {
            ...
            /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":122
 * 
 *                     if weight[ii, jj] > weight[i, j]:
 *                         weight[i, j] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":124
 *                         weight[i, j] = 0
 * 
 *     _log.info('Features found: %s' % np.sum(weight != 0))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":126
 *     _log.info('Features found: %s' % np.sum(weight != 0))
 * 
 *     mask = (strength != 0)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":127
 * 
 *     mask = (strength != 0)
 *     area[mask] /= strength[mask]             # <<<<<<<<<<<<<<
 *     return weight * strength, area
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":128
 *     mask = (strength != 0)
 *     area[mask] /= strength[mask]
 *     return weight * strength, area             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":9
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":11
 * __all__ = ['features']
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":18
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":19
 * 
 * import supreme.config
 * _log = supreme.config.get_log(__name__)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/feature/dpt.pyx":1
 * # -*- python -*-             # <<<<<<<<<<<<<<
 * 
