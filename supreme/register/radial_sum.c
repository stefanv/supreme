/* Generated by Cython 0.11.3 on Mon Dec 14 23:28:43 2009 */
...
static PyObject *__pyx_pf_7supreme_8register_10radial_sum_radial_sum(PyObject *__pyx_self, PyObject *__pyx_v_patch) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":38
 * 
 *     """
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":43
 * 
 *     M = patch.shape[0]
 *     N = patch.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":45
 *     N = patch.shape[1]
 * 
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":46
 * 
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             ii = i - (M - 1)/2
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":47
 *     for i in range(M):
 *         for j in range(N):
 *             ii = i - (M - 1)/2             # <<<<<<<<<<<<<<
 *             jj = j - (N - 1)/2
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":48
 *         for j in range(N):
 *             ii = i - (M - 1)/2
 *             jj = j - (N - 1)/2             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":51
 * 
 *             # Ignore middle pixel
 *             if ii == 0 and jj == 0:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":52
 *             # Ignore middle pixel
 *             if ii == 0 and jj == 0:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":55
 * 
 *             # Use -1 to mask transparency
 *             if patch[i, j] == -1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":56
 *             # Use -1 to mask transparency
 *             if patch[i, j] == -1:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":58
 *                 continue
 * 
 *             if jj == 0 and ii > 0:             # <<<<<<<<<<<<<<
 *                 out[90] += patch[i, j]
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":59
 * 
 *             if jj == 0 and ii > 0:
 *                 out[90] += patch[i, j]             # <<<<<<<<<<<<<<
 *             elif jj == 0 and ii < 0:
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":60
 *             if jj == 0 and ii > 0:
 *                 out[90] += patch[i, j]
 *             elif jj == 0 and ii < 0:             # <<<<<<<<<<<<<<
 *                 out[270] += patch[i, j]
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":61
 *                 out[90] += patch[i, j]
 *             elif jj == 0 and ii < 0:
 *                 out[270] += patch[i, j]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":63
 *                 out[270] += patch[i, j]
 *             else:
 *                 angle = -atanf(ii / float(jj)) / np.pi * 180             # <<<<<<<<<<<<<<
 *                 if jj < 0:
 ...
 */
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":64
 *             else:
 *                 angle = -atanf(ii / float(jj)) / np.pi * 180
 *                 if jj < 0:             # <<<<<<<<<<<<<<
 *                     angle += 180
 ...
 */
        ...
        if (__pyx_t_11) {
          ...
          /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":65
 *                 angle = -atanf(ii / float(jj)) / np.pi * 180
 *                 if jj < 0:
 *                     angle += 180             # <<<<<<<<<<<<<<
 *                 out[round(angle % 360)] += patch[i, j]
 ...
 */
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":66
 *                 if jj < 0:
 *                     angle += 180
 *                 out[round(angle % 360)] += patch[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/radial_sum.pyx":68
 *                 out[round(angle % 360)] += patch[i, j]
 * 
 *     return out             # <<<<<<<<<<<<<<
 */
