/* Generated by Cython 0.11.3 on Mon Dec 14 00:52:29 2009 */
...
static char __pyx_k_11[] = "Fast Parzen-Window-like estimator of the joint histogram between two\nimages.\n\n";
static char __pyx_k_12[] = "joint_hist (line 39)";
static char __pyx_k_13[] = "mutual_info (line 114)";
...
static char __pyx_k__mgrid[] = "mgrid";
...
static char __pyx_k__ignore_black[] = "ignore_black";
...
static PyObject *__pyx_n_s__ignore_black;
static PyObject *__pyx_n_s__itemsize;
static PyObject *__pyx_n_s__joint_hist;
static PyObject *__pyx_n_s__mgrid;
...
/* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":15
 * 
...
static  PyArrayObject *__pyx_f_7supreme_8register_6parzen__add_window(PyArrayObject *__pyx_v_out_arr, int __pyx_v_m, int __pyx_v_n, PyArrayObject *__pyx_v_win_arr) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":17
 * cdef np.ndarray _add_window(np.ndarray out_arr, int m, int n,
 *                             np.ndarray win_arr):
 *     cdef np.ndarray[np.double_t, ndim=2] out = out_arr             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":18
 *                             np.ndarray win_arr):
 *     cdef np.ndarray[np.double_t, ndim=2] out = out_arr
 *     cdef np.ndarray[np.double_t, ndim=2] w = win_arr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":20
 *     cdef np.ndarray[np.double_t, ndim=2] w = win_arr
 * 
 *     cdef int hwin = (win_arr.shape[0] - 1)/2             # <<<<<<<<<<<<<<
 *     cdef int i, j, ii, jj
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":23
 *     cdef int i, j, ii, jj
 *     cdef int M, N
 *     M = out_arr.shape[0]             # <<<<<<<<<<<<<<
 *     N = out_arr.shape[1]
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":24
 *     cdef int M, N
 *     M = out_arr.shape[0]
 *     N = out_arr.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":26
 *     N = out_arr.shape[1]
 * 
 *     for i in range(-hwin, hwin + 1):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_2 = (-__pyx_v_hwin); __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":27
 * 
 *     for i in range(-hwin, hwin + 1):
 *         for j in range(-hwin, hwin + 1):             # <<<<<<<<<<<<<<
 *             ii = i + m
 ...
 */
    ...
    for (__pyx_t_4 = (-__pyx_v_hwin); __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":28
 *     for i in range(-hwin, hwin + 1):
 *         for j in range(-hwin, hwin + 1):
 *             ii = i + m             # <<<<<<<<<<<<<<
 *             jj = j + n
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":29
 *         for j in range(-hwin, hwin + 1):
 *             ii = i + m
 *             jj = j + n             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":31
 *             jj = j + n
 * 
 *             if (ii < 0) or (ii >= M) or (jj < 0) or (jj >= N):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":32
 * 
 *             if (ii < 0) or (ii >= M) or (jj < 0) or (jj >= N):
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":34
 *                 continue
 * 
 *             out[ii, jj] += w[i + hwin, j + hwin]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":36
 *             out[ii, jj] += w[i + hwin, j + hwin]
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":39
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_7supreme_8register_6parzen_joint_hist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_t_23;
  int __pyx_t_24;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__A,&__pyx_n_s__B,&__pyx_n_s__win_size,&__pyx_n_s__std,&__pyx_n_s__fast,&__pyx_n_s__ignore_black,0};
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("joint_hist", 0, 2, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      if (kw_args > 0) {
      ...
      case  5:
      if (kw_args > 0) {
        PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s__ignore_black);
        if (unlikely(value)) { values[5] = value; kw_args--; }
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "joint_hist") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    ...
    if (values[4]) {
      __pyx_v_fast = __Pyx_PyInt_AsInt(values[4]); if (unlikely((__pyx_v_fast == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_fast = ((int)0);
    }
    if (values[5]) {
      __pyx_v_ignore_black = __Pyx_PyInt_AsInt(values[5]); if (unlikely((__pyx_v_ignore_black == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_ignore_black = ((int)0);
    }
  } else {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  6:
      __pyx_v_ignore_black = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_ignore_black == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  5:
      __pyx_v_fast = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely((__pyx_v_fast == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  4:
      __pyx_v_std = PyTuple_GET_ITEM(__pyx_args, 3);
      case  3:
  ...
  __Pyx_RaiseArgtupleInvalid("joint_hist", 0, 2, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  __pyx_v_hwin = Py_None; __Pyx_INCREF(Py_None);
  __pyx_bstruct_out.buf = NULL;
  __pyx_bstruct_w.buf = NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_B), __pyx_ptype_5numpy_ndarray, 1, "B", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_A, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_B, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":69
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":70
 * 
 *     if not (A.shape[0] == B.shape[0]) and (A.shape[1] == B.shape[1]):
 *         raise IndexError("Shapes of both input arrays must be equal.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_3 = PyObject_Call(__pyx_builtin_IndexError, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":75
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":76
 * 
 *     if not fast:
 *         x, y = np.mgrid[:win_size, :win_size]             # <<<<<<<<<<<<<<
 *         hwin = (win_size - 1) / 2
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__mgrid); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PySlice_New(Py_None, __pyx_v_win_size, Py_None); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PySlice_New(Py_None, __pyx_v_win_size, Py_None); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_3 = 0;
    __pyx_t_4 = 0;
    __pyx_t_4 = PyObject_GetItem(__pyx_t_2, __pyx_t_5); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    if (PyTuple_CheckExact(__pyx_t_4) && likely(PyTuple_GET_SIZE(__pyx_t_4) == 2)) {
      ...
      __pyx_t_3 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_5 = __Pyx_UnpackItem(__pyx_t_3, 0); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_2 = __Pyx_UnpackItem(__pyx_t_3, 1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      if (__Pyx_EndUnpack(__pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_v_x);
      __pyx_v_x = __pyx_t_5;
      __pyx_t_5 = 0;
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":77
 *     if not fast:
 *         x, y = np.mgrid[:win_size, :win_size]
 *         hwin = (win_size - 1) / 2             # <<<<<<<<<<<<<<
 *         x -= hwin
 *         y -= hwin
 */
    __pyx_t_4 = PyNumber_Subtract(__pyx_v_win_size, __pyx_int_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_v_hwin);
    __pyx_v_hwin = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":78
 *         x, y = np.mgrid[:win_size, :win_size]
 *         hwin = (win_size - 1) / 2
 *         x -= hwin             # <<<<<<<<<<<<<<
 *         y -= hwin
 *         std = float(std)
 */
    __pyx_t_2 = PyNumber_InPlaceSubtract(__pyx_v_x, __pyx_v_hwin); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_v_x);
    __pyx_v_x = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":79
 *         hwin = (win_size - 1) / 2
 *         x -= hwin
 *         y -= hwin             # <<<<<<<<<<<<<<
 *         std = float(std)
 ...
 */
    __pyx_t_2 = PyNumber_InPlaceSubtract(__pyx_v_y, __pyx_v_hwin); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_v_y);
    __pyx_v_y = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":80
 *         x -= hwin
 *         y -= hwin
 *         std = float(std)             # <<<<<<<<<<<<<<
 *         w = np.exp(-(x**2 + y**2)/(2 ** std**2)) / (2 * np.pi * std**2)
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_INCREF(__pyx_v_std);
    PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_std);
    __Pyx_GIVEREF(__pyx_v_std);
    __pyx_t_4 = PyObject_Call(((PyObject *)((PyObject*)&PyFloat_Type)), __pyx_t_2, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":81
 *         y -= hwin
 *         std = float(std)
 *         w = np.exp(-(x**2 + y**2)/(2 ** std**2)) / (2 * np.pi * std**2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__exp); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Power(__pyx_v_x, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = PyNumber_Power(__pyx_v_y, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = PyNumber_Add(__pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Power(__pyx_v_std, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyNumber_Power(__pyx_int_2, __pyx_t_3, Py_None); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyNumber_Divide(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_GIVEREF(__pyx_t_3);
    __pyx_t_3 = 0;
    __pyx_t_3 = PyObject_Call(__pyx_t_2, __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__pi); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Multiply(__pyx_int_2, __pyx_t_2); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Power(__pyx_v_std, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_5 = PyNumber_Multiply(__pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (!(__Pyx_TypeTest(__pyx_t_2, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_6 = ((PyArrayObject *)__pyx_t_2);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_bstruct_w);
      __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_w, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":83
 *         w = np.exp(-(x**2 + y**2)/(2 ** std**2)) / (2 * np.pi * std**2)
 * 
 *     out = np.zeros((255, 255), dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__zeros); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_11 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__double); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, ((PyObject *)__pyx_n_s__dtype), __pyx_t_11) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = PyEval_CallObjectWithKeywords(__pyx_t_5, __pyx_t_3, ((PyObject *)__pyx_t_2)); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_11, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_12 = ((PyArrayObject *)__pyx_t_11);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_out);
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_7 < 0)) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":86
 * 
 *     cdef int m, n, i, j, a, b
 *     m = A.shape[0]             # <<<<<<<<<<<<<<
 *     n = A.shape[1]
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":87
 *     cdef int m, n, i, j, a, b
 *     m = A.shape[0]
 *     n = A.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":89
 *     n = A.shape[1]
 * 
 *     for i in range(m):             # <<<<<<<<<<<<<<
 *         for j in range(n):
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_7; __pyx_t_13+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":90
 * 
 *     for i in range(m):
 *         for j in range(n):             # <<<<<<<<<<<<<<
 *             a = A[i, j]
 ...
 */
    ...
    for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":91
 *     for i in range(m):
 *         for j in range(n):
 *             a = A[i, j]             # <<<<<<<<<<<<<<
 *             b = B[i, j]
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":92
 *         for j in range(n):
 *             a = A[i, j]
 *             b = B[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":94
 *             b = B[i, j]
 * 
 *             if ignore_black and \             # <<<<<<<<<<<<<<
 ...
 *                 continue
 */
      if (__pyx_v_ignore_black) {

        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":95
 * 
 *             if ignore_black and \
 *                ((a == 0 or b == 0) and not (a == 0 and b == 0)):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
        ...
        __pyx_t_1 = __pyx_v_ignore_black;
      }
      if (__pyx_t_1) {

        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":96
 *             if ignore_black and \
 *                ((a == 0 or b == 0) and not (a == 0 and b == 0)):
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":98
 *                 continue
 * 
 *             if fast:             # <<<<<<<<<<<<<<
 *                 out[a, b] += 1
 *             else:
 */
      __pyx_t_22 = __pyx_v_fast;
      if (__pyx_t_22) {

        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":99
 * 
 *             if fast:
 *                 out[a, b] += 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_out.buf, __pyx_t_22, __pyx_bstride_0_out, __pyx_t_23, __pyx_bstride_1_out) += 1;
        goto __pyx_L13;
      }
      /*else*/ {

        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":101
 *                 out[a, b] += 1
 *             else:
 *                 out = _add_window(out, a, b, w)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_11 = ((PyObject *)__pyx_f_7supreme_8register_6parzen__add_window(((PyArrayObject *)__pyx_v_out), __pyx_v_a, __pyx_v_b, ((PyArrayObject *)__pyx_v_w))); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
        {
          __Pyx_BufFmt_StackElem __pyx_stack[1];
          __Pyx_SafeReleaseBuffer(&__pyx_bstruct_out);
          __pyx_t_24 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)((PyArrayObject *)__pyx_t_11), &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack);
          ...
          __pyx_bstride_0_out = __pyx_bstruct_out.strides[0]; __pyx_bstride_1_out = __pyx_bstruct_out.strides[1];
          __pyx_bshape_0_out = __pyx_bstruct_out.shape[0]; __pyx_bshape_1_out = __pyx_bstruct_out.shape[1];
          if (unlikely(__pyx_t_24 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __Pyx_DECREF(((PyObject *)__pyx_v_out));
        __pyx_v_out = ((PyArrayObject *)__pyx_t_11);
        __pyx_t_11 = 0;
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":105
 *     # Normalisation not needed if the correct window is provided
 * 
 *     cdef double s = 0             # <<<<<<<<<<<<<<
 *     for i in range(255):
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":106
 * 
 *     cdef double s = 0
 *     for i in range(255):             # <<<<<<<<<<<<<<
 *         for j in range(255):
 *             s += out[i, j]
 */
  for (__pyx_t_7 = 0; __pyx_t_7 < 255; __pyx_t_7+=1) {
    __pyx_v_i = __pyx_t_7;

    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":107
 *     cdef double s = 0
 *     for i in range(255):
 *         for j in range(255):             # <<<<<<<<<<<<<<
 *             s += out[i, j]
 ...
 */
    for (__pyx_t_13 = 0; __pyx_t_13 < 255; __pyx_t_13+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":108
 *     for i in range(255):
 *         for j in range(255):
 *             s += out[i, j]             # <<<<<<<<<<<<<<
 *     out /= s
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":109
 *         for j in range(255):
 *             s += out[i, j]
 *     out /= s             # <<<<<<<<<<<<<<
 * 
 *     return out
 */
  __pyx_t_11 = PyFloat_FromDouble(__pyx_v_s); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_2 = PyNumber_InPlaceDivide(((PyObject *)__pyx_v_out), __pyx_t_11); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":111
 *     out /= s
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":114
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_7supreme_8register_6parzen_mutual_info(PyObject *__pyx_self, PyObject *__pyx_v_H) {
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_H), __pyx_ptype_5numpy_ndarray, 1, "H", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_H, (PyObject*)__pyx_v_H, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":133
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":134
 * 
 *     M = H.shape[0]
 *     N = H.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":136
 *     N = H.shape[1]
 * 
 *     hR = np.zeros(M, dtype=np.double)             # <<<<<<<<<<<<<<
 *     for i in range(M):
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_M); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__double); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__dtype), __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_3, ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_5, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":137
 * 
 *     hR = np.zeros(M, dtype=np.double)
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_7; __pyx_t_11+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":138
 *     hR = np.zeros(M, dtype=np.double)
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             hR[i] += H[i, j]
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":139
 *     for i in range(M):
 *         for j in range(N):
 *             hR[i] += H[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":141
 *             hR[i] += H[i, j]
 * 
 *     hC = np.zeros(N, dtype=np.double)             # <<<<<<<<<<<<<<
 *     for i in range(M):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__double); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, ((PyObject *)__pyx_n_s__dtype), __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyEval_CallObjectWithKeywords(__pyx_t_1, __pyx_t_3, ((PyObject *)__pyx_t_5)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_5)); __pyx_t_5 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_6 = 0;
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":142
 * 
 *     hC = np.zeros(N, dtype=np.double)
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_7; __pyx_t_11+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":143
 *     hC = np.zeros(N, dtype=np.double)
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             hC[j] += H[i, j]
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":144
 *     for i in range(M):
 *         for j in range(N):
 *             hC[j] += H[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":146
 *             hC[j] += H[i, j]
 * 
 *     S = 0             # <<<<<<<<<<<<<<
 *     for i in range(M):
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":147
 * 
 *     S = 0
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_7; __pyx_t_11+=1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":148
 *     S = 0
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             if H[i, j] == 0 or hR[i] == 0 or hC[j] == 0:
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":149
 *     for i in range(M):
 *         for j in range(N):
 *             if H[i, j] == 0 or hR[i] == 0 or hC[j] == 0:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_25) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":150
 *         for j in range(N):
 *             if H[i, j] == 0 or hR[i] == 0 or hC[j] == 0:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":152
 *                 continue
 * 
 *             S += H[i, j] * logf(H[i, j] / (hR[i] * hC[j])) / logf(2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_bshape_0_H;
      if (__pyx_t_27 < 0) __pyx_t_27 += __pyx_bshape_1_H;
      __pyx_t_28 = __pyx_v_i;
      __pyx_t_29 = __pyx_v_j;
      if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_bshape_0_H;
      if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_bshape_1_H;
      __pyx_t_30 = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_28, __pyx_bstride_0_H, __pyx_t_29, __pyx_bstride_1_H));
      __pyx_t_31 = __pyx_v_i;
      if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_bshape_0_hR;
      __pyx_t_32 = __pyx_v_j;
      if (__pyx_t_32 < 0) __pyx_t_32 += __pyx_bshape_0_hC;
      __pyx_t_33 = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hR.buf, __pyx_t_31, __pyx_bstride_0_hR)) * (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hC.buf, __pyx_t_32, __pyx_bstride_0_hC)));
      if (unlikely(__pyx_t_33 == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 152; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_34 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_26, __pyx_bstride_0_H, __pyx_t_27, __pyx_bstride_1_H)) * logf((__pyx_t_30 / __pyx_t_33)));
      __pyx_t_35 = logf(2);
      if (unlikely(__pyx_t_35 == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 152; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_S += (__pyx_t_34 / __pyx_t_35);
      __pyx_L15_continue:;
    }
  }

  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":160
 * ##     S = -np.sum(H[mask] * np.log(h[mask])) / np.log(2)
 * 
 *     return S             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = PyFloat_FromDouble(__pyx_v_S); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__ignore_black, __pyx_k__ignore_black, sizeof(__pyx_k__ignore_black), 0, 0, 1, 1},
  ...
  {&__pyx_n_s__mgrid, __pyx_k__mgrid, sizeof(__pyx_k__mgrid), 0, 0, 1, 1},
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_IndexError = __Pyx_GetName(__pyx_b, __pyx_n_s__IndexError); if (!__pyx_builtin_IndexError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":7
 * 
 * """
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":40
 * @cython.boundscheck(False)
 * def joint_hist(np.ndarray[np.uint8_t, ndim=2] A,
 *                np.ndarray[np.uint8_t, ndim=2] B, win_size=5, std=1.0,             # <<<<<<<<<<<<<<
 *                int fast=0, int ignore_black=0):
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":1
 * # -*- python -*-             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_t_1));
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__joint_hist); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
