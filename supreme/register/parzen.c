/* Generated by Cython 0.11.3 on Wed May 12 13:51:30 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__supreme__register__parzen
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from supreme.register.parzen */

static PyArrayObject *__pyx_f_7supreme_8register_6parzen__add_window(PyArrayObject *, int, int, PyArrayObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "supreme.register.parzen"
int __pyx_module_is_main_supreme__register__parzen = 0;

/* Implementation of supreme.register.parzen */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_IndexError;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static char __pyx_k_2[] = "Shapes of both input arrays must be equal.";
...
static char __pyx_k_11[] = "Fast Parzen-Window-like estimator of the joint histogram between two images.\n\n";
static char __pyx_k_12[] = "supreme.geometry.window";
static char __pyx_k_13[] = "joint_hist (line 41)";
static char __pyx_k_14[] = "mutual_info (line 110)";
...
static char __pyx_k__joint_hist[] = "joint_hist";
static char __pyx_k__suboffsets[] = "suboffsets";
static char __pyx_k__mutual_info[] = "mutual_info";
...
static PyObject *__pyx_n_s__joint_hist;
static PyObject *__pyx_n_s__mutual_info;
...
/* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":17
 * 
...
static  PyArrayObject *__pyx_f_7supreme_8register_6parzen__add_window(PyArrayObject *__pyx_v_out_arr, int __pyx_v_m, int __pyx_v_n, PyArrayObject *__pyx_v_win_arr) {
  ...
  int __pyx_t_9;
  int __pyx_t_10;
  __Pyx_SetupRefcountContext("_add_window");
  __Pyx_INCREF((PyObject *)__pyx_v_out_arr);
  __Pyx_INCREF((PyObject *)__pyx_v_win_arr);
  __pyx_bstruct_out.buf = NULL;
  __pyx_bstruct_w.buf = NULL;

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":19
 * cdef np.ndarray _add_window(np.ndarray out_arr, int m, int n,
 *                             np.ndarray win_arr):
 *     cdef np.ndarray[np.double_t, ndim=2] out = out_arr             # <<<<<<<<<<<<<<
 ...
 */
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)((PyArrayObject *)__pyx_v_out_arr), &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_out_arr));
  __pyx_v_out = ((PyArrayObject *)__pyx_v_out_arr);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":20
 *                             np.ndarray win_arr):
 *     cdef np.ndarray[np.double_t, ndim=2] out = out_arr
 *     cdef np.ndarray[np.double_t, ndim=2] w = win_arr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_w, (PyObject*)((PyArrayObject *)__pyx_v_win_arr), &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_win_arr));
  __pyx_v_w = ((PyArrayObject *)__pyx_v_win_arr);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":22
 *     cdef np.ndarray[np.double_t, ndim=2] w = win_arr
 * 
 *     cdef int hwin = (win_arr.shape[0] - 1)/2             # <<<<<<<<<<<<<<
 *     cdef int i, j, ii, jj
 *     cdef int M, N
 */
  __pyx_v_hwin = __Pyx_div_long(((__pyx_v_win_arr->dimensions[0]) - 1), 2);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":25
 *     cdef int i, j, ii, jj
 *     cdef int M, N
 *     M = out_arr.shape[0]             # <<<<<<<<<<<<<<
 *     N = out_arr.shape[1]
 * 
 */
  __pyx_v_M = (__pyx_v_out_arr->dimensions[0]);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":26
 *     cdef int M, N
 *     M = out_arr.shape[0]
 *     N = out_arr.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_N = (__pyx_v_out_arr->dimensions[1]);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":28
 *     N = out_arr.shape[1]
 * 
 *     for i in range(-hwin, hwin + 1):             # <<<<<<<<<<<<<<
 ...
 *             ii = i + m
 */
  __pyx_t_1 = (__pyx_v_hwin + 1);
  for (__pyx_t_2 = (-__pyx_v_hwin); __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    __pyx_v_i = __pyx_t_2;

    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":29
 * 
 *     for i in range(-hwin, hwin + 1):
 *         for j in range(-hwin, hwin + 1):             # <<<<<<<<<<<<<<
 *             ii = i + m
 *             jj = j + n
 */
    __pyx_t_3 = (__pyx_v_hwin + 1);
    for (__pyx_t_4 = (-__pyx_v_hwin); __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_j = __pyx_t_4;

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":30
 *     for i in range(-hwin, hwin + 1):
 *         for j in range(-hwin, hwin + 1):
 *             ii = i + m             # <<<<<<<<<<<<<<
 *             jj = j + n
 * 
 */
      __pyx_v_ii = (__pyx_v_i + __pyx_v_m);

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":31
 *         for j in range(-hwin, hwin + 1):
 *             ii = i + m
 *             jj = j + n             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_jj = (__pyx_v_j + __pyx_v_n);

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":33
 *             jj = j + n
 * 
 *             if (ii < 0) or (ii >= M) or (jj < 0) or (jj >= N):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      if (!(__pyx_v_ii < 0)) {
        if (!(__pyx_v_ii >= __pyx_v_M)) {
          if (!(__pyx_v_jj < 0)) {
            __pyx_t_5 = (__pyx_v_jj >= __pyx_v_N);
          } else {
            __pyx_t_5 = (__pyx_v_jj < 0);
          }
          __pyx_t_6 = __pyx_t_5;
        } else {
          __pyx_t_6 = (__pyx_v_ii >= __pyx_v_M);
        }
        __pyx_t_5 = __pyx_t_6;
      } else {
      ...
      if (__pyx_t_5) {
        ...
        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":34
 * 
 *             if (ii < 0) or (ii >= M) or (jj < 0) or (jj >= N):
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":36
 *                 continue
 * 
 *             out[ii, jj] += w[i + hwin, j + hwin]             # <<<<<<<<<<<<<<
 * 
 *     return out
 */
      __pyx_t_7 = (__pyx_v_i + __pyx_v_hwin);
      __pyx_t_8 = (__pyx_v_j + __pyx_v_hwin);
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_bshape_0_w;
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_bshape_1_w;
      __pyx_t_9 = __pyx_v_ii;
      __pyx_t_10 = __pyx_v_jj;
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_bshape_0_out;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_bshape_1_out;
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_out.buf, __pyx_t_9, __pyx_bstride_0_out, __pyx_t_10, __pyx_bstride_1_out) += (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_w.buf, __pyx_t_7, __pyx_bstride_0_w, __pyx_t_8, __pyx_bstride_1_w));
      __pyx_L5_continue:;
    }
  }

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":38
 *             out[ii, jj] += w[i + hwin, j + hwin]
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("supreme.register.parzen._add_window");
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_w);
  ...
  __Pyx_DECREF((PyObject *)__pyx_v_out_arr);
  __Pyx_DECREF((PyObject *)__pyx_v_win_arr);
  __Pyx_XGIVEREF((PyObject *)__pyx_r);
  __Pyx_FinishRefcountContext();
  return __pyx_r;
}

/* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":41
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_7supreme_8register_6parzen_joint_hist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_t_20;
  double __pyx_t_21;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__A,&__pyx_n_s__B,&__pyx_n_s__L,&__pyx_n_s__win_size,&__pyx_n_s__std,&__pyx_n_s__fast,0};
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("joint_hist", 0, 2, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      if (kw_args > 0) {
      ...
      case  5:
      if (kw_args > 0) {
        PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s__fast);
        if (unlikely(value)) { values[5] = value; kw_args--; }
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "joint_hist") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_A = ((PyArrayObject *)values[0]);
    __pyx_v_B = ((PyArrayObject *)values[1]);
    __pyx_v_L = values[2];
    __pyx_v_win_size = values[3];
    __pyx_v_std = values[4];
    if (values[5]) {
      __pyx_v_fast = __Pyx_PyInt_AsInt(values[5]); if (unlikely((__pyx_v_fast == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_fast = ((int)0);
    }
  } else {
    __pyx_v_L = ((PyObject *)__pyx_int_255);
    __pyx_v_win_size = ((PyObject *)__pyx_int_5);
    __pyx_v_std = __pyx_k_1;
    __pyx_v_fast = ((int)0);
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  6:
      __pyx_v_fast = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_fast == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  5:
      __pyx_v_std = PyTuple_GET_ITEM(__pyx_args, 4);
      case  4:
      __pyx_v_win_size = PyTuple_GET_ITEM(__pyx_args, 3);
      case  3:
      __pyx_v_L = PyTuple_GET_ITEM(__pyx_args, 2);
      case  2:
  ...
  __Pyx_RaiseArgtupleInvalid("joint_hist", 0, 2, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("supreme.register.parzen.joint_hist");
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_A), __pyx_ptype_5numpy_ndarray, 1, "A", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_B), __pyx_ptype_5numpy_ndarray, 1, "B", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_A, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_B, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":73
 ...
 * 
 */
  if ((!((__pyx_v_A->dimensions[0]) == (__pyx_v_B->dimensions[0])))) {
    __pyx_t_1 = ((__pyx_v_A->dimensions[1]) == (__pyx_v_B->dimensions[1]));
  } else {
    __pyx_t_1 = (!((__pyx_v_A->dimensions[0]) == (__pyx_v_B->dimensions[0])));
  }
  if (__pyx_t_1) {

    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":74
 * 
 *     if not (A.shape[0] == B.shape[0]) and (A.shape[1] == B.shape[1]):
 *         raise IndexError("Shapes of both input arrays must be equal.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_3 = PyObject_Call(__pyx_builtin_IndexError, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":79
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":80
 * 
 *     if not fast:
 *         w = gauss(win_size, std)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__gauss); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_INCREF(__pyx_v_win_size);
    PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_win_size);
    __Pyx_GIVEREF(__pyx_v_win_size);
    __Pyx_INCREF(__pyx_v_std);
    PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_v_std);
    __Pyx_GIVEREF(__pyx_v_std);
    __pyx_t_4 = PyObject_Call(__pyx_t_3, __pyx_t_2, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (!(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_5 = ((PyArrayObject *)__pyx_t_4);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_bstruct_w);
      __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_w, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
      if (unlikely(__pyx_t_6 < 0)) {
        PyErr_Fetch(&__pyx_t_7, &__pyx_t_8, &__pyx_t_9);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_w, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":82
 *         w = gauss(win_size, std)
 * 
 *     out = np.zeros((L, L), dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__zeros); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_10 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = PyObject_GetAttr(__pyx_t_10, __pyx_n_s__double); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  if (PyDict_SetItem(__pyx_t_4, ((PyObject *)__pyx_n_s__dtype), __pyx_t_11) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_3, ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_11, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_12 = ((PyArrayObject *)__pyx_t_11);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_out);
    __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_6 < 0)) {
      PyErr_Fetch(&__pyx_t_9, &__pyx_t_8, &__pyx_t_7);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)__pyx_v_out, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
    ...
    __pyx_bshape_0_out = __pyx_bstruct_out.shape[0]; __pyx_bshape_1_out = __pyx_bstruct_out.shape[1];
    if (unlikely(__pyx_t_6 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_12 = 0;
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":85
 * 
 *     cdef int m, n, i, j, a, b
 *     m = A.shape[0]             # <<<<<<<<<<<<<<
 *     n = A.shape[1]
 ...
 */
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":86
 *     cdef int m, n, i, j, a, b
 *     m = A.shape[0]
 *     n = A.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":88
 *     n = A.shape[1]
 * 
 *     for i in range(m):             # <<<<<<<<<<<<<<
 *         for j in range(n):
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_6; __pyx_t_13+=1) {
    ...
    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":89
 * 
 *     for i in range(m):
 *         for j in range(n):             # <<<<<<<<<<<<<<
 *             a = A[i, j]
 ...
 */
    ...
    for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":90
 *     for i in range(m):
 *         for j in range(n):
 *             a = A[i, j]             # <<<<<<<<<<<<<<
 *             b = B[i, j]
 ...
 */
      ...
      __pyx_v_a = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_uint8_t *, __pyx_bstruct_A.buf, __pyx_t_16, __pyx_bstride_0_A, __pyx_t_17, __pyx_bstride_1_A));

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":91
 *         for j in range(n):
 *             a = A[i, j]
 *             b = B[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_bshape_0_B;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_bshape_1_B;
      __pyx_v_b = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_uint8_t *, __pyx_bstruct_B.buf, __pyx_t_18, __pyx_bstride_0_B, __pyx_t_19, __pyx_bstride_1_B));

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":93
 *             b = B[i, j]
 * 
 *             if fast:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_20 = __pyx_v_fast;
      if (__pyx_t_20) {

        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":94
 * 
 *             if fast:
 *                 out[(int)(round(a / 255. * (L - 1))),             # <<<<<<<<<<<<<<
 *                     (int)(round(b / 255. * (L - 1)))] += 1
 *             else:
 */
        __pyx_t_11 = PyFloat_FromDouble((__pyx_v_a / 255.0)); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_4 = PyNumber_Subtract(__pyx_v_L, __pyx_int_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_3 = PyNumber_Multiply(__pyx_t_11, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_21 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = PyFloat_FromDouble(round(__pyx_t_21)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        ...
        __pyx_t_3 = 0;
        __pyx_t_3 = PyObject_Call(((PyObject *)((PyObject*)&PyInt_Type)), __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":95
 *             if fast:
 *                 out[(int)(round(a / 255. * (L - 1))),
 *                     (int)(round(b / 255. * (L - 1)))] += 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        __pyx_t_4 = PyFloat_FromDouble((__pyx_v_b / 255.0)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_11 = PyNumber_Subtract(__pyx_v_L, __pyx_int_1); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_2 = PyNumber_Multiply(__pyx_t_4, __pyx_t_11); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_21 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = PyFloat_FromDouble(round(__pyx_t_21)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        ...
        __pyx_t_2 = 0;
        __pyx_t_2 = PyObject_Call(((PyObject *)((PyObject*)&PyInt_Type)), __pyx_t_11, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        ...
        __pyx_t_3 = 0;
        __pyx_t_2 = 0;
        __pyx_t_2 = PyObject_GetItem(((PyObject *)__pyx_v_out), __pyx_t_11); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_3 = PyNumber_InPlaceAdd(__pyx_t_2, __pyx_int_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
 ...
 */
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        if (PyObject_SetItem(((PyObject *)__pyx_v_out), __pyx_t_11, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        goto __pyx_L12;
      }
      /*else*/ {
        ...
        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":97
 *                     (int)(round(b / 255. * (L - 1)))] += 1
 *             else:
 *                 out = _add_window(out, a, b, w)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_11 = ((PyObject *)__pyx_f_7supreme_8register_6parzen__add_window(((PyArrayObject *)__pyx_v_out), __pyx_v_a, __pyx_v_b, ((PyArrayObject *)__pyx_v_w))); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
        {
          __Pyx_BufFmt_StackElem __pyx_stack[1];
          __Pyx_SafeReleaseBuffer(&__pyx_bstruct_out);
          __pyx_t_20 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_out, (PyObject*)((PyArrayObject *)__pyx_t_11), &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
          ...
          __pyx_bstride_0_out = __pyx_bstruct_out.strides[0]; __pyx_bstride_1_out = __pyx_bstruct_out.strides[1];
          __pyx_bshape_0_out = __pyx_bstruct_out.shape[0]; __pyx_bshape_1_out = __pyx_bstruct_out.shape[1];
          if (unlikely(__pyx_t_20 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __Pyx_DECREF(((PyObject *)__pyx_v_out));
        __pyx_v_out = ((PyArrayObject *)__pyx_t_11);
        __pyx_t_11 = 0;
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":101
 *     # Normalisation not needed if the correct window is provided
 * 
 *     cdef double s = 0             # <<<<<<<<<<<<<<
 *     for i in range(255):
 ...
 */
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":102
 * 
 *     cdef double s = 0
 *     for i in range(255):             # <<<<<<<<<<<<<<
 *         for j in range(255):
 *             s += out[i, j]
 */
  for (__pyx_t_6 = 0; __pyx_t_6 < 255; __pyx_t_6+=1) {
    __pyx_v_i = __pyx_t_6;

    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":103
 *     cdef double s = 0
 *     for i in range(255):
 *         for j in range(255):             # <<<<<<<<<<<<<<
 *             s += out[i, j]
 *     out /= s
 */
    for (__pyx_t_13 = 0; __pyx_t_13 < 255; __pyx_t_13+=1) {
      __pyx_v_j = __pyx_t_13;

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":104
 *     for i in range(255):
 *         for j in range(255):
 *             s += out[i, j]             # <<<<<<<<<<<<<<
 *     out /= s
 ...
 */
      ...
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_bshape_1_out;
      __pyx_v_s += (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_out.buf, __pyx_t_14, __pyx_bstride_0_out, __pyx_t_15, __pyx_bstride_1_out));
    }
  }

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":105
 *         for j in range(255):
 *             s += out[i, j]
 *     out /= s             # <<<<<<<<<<<<<<
 * 
 *     return out
 */
  __pyx_t_11 = PyFloat_FromDouble(__pyx_v_s); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_3 = PyNumber_InPlaceDivide(((PyObject *)__pyx_v_out), __pyx_t_11); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  if (!(__Pyx_TypeTest(__pyx_t_3, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":107
 *     out /= s
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
...
/* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":110
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_7supreme_8register_6parzen_mutual_info(PyObject *__pyx_self, PyObject *__pyx_v_H); /*proto*/
static char __pyx_doc_7supreme_8register_6parzen_mutual_info[] = "Given the joint histogram of two images, calculate\n    their mutual information.\n\n    Parameters\n    ----------\n    H : (256, 256) ndarray of double\n\n    Returns\n    -------\n    S : float\n        Mutual information.\n\n    ";
static PyObject *__pyx_pf_7supreme_8register_6parzen_mutual_info(PyObject *__pyx_self, PyObject *__pyx_v_H) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_M;
  int __pyx_v_N;
  double __pyx_v_S;
  PyArrayObject *__pyx_v_hR;
  PyArrayObject *__pyx_v_hC;
  double __pyx_v_den;
  ...
  Py_buffer __pyx_bstruct_hR;
  Py_ssize_t __pyx_bstride_0_hR = 0;
  Py_ssize_t __pyx_bshape_0_hR = 0;
  Py_buffer __pyx_bstruct_hC;
  Py_ssize_t __pyx_bstride_0_hC = 0;
  Py_ssize_t __pyx_bshape_0_hC = 0;
  PyObject *__pyx_r = NULL;
  ...
  double __pyx_t_34;
  __Pyx_SetupRefcountContext("mutual_info");
  __pyx_self = __pyx_self;
  __Pyx_INCREF((PyObject *)__pyx_v_H);
  __pyx_v_hR = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_v_hC = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None);
  __pyx_bstruct_hR.buf = NULL;
  __pyx_bstruct_hC.buf = NULL;
  __pyx_bstruct_H.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_H), __pyx_ptype_5numpy_ndarray, 1, "H", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_H, (PyObject*)__pyx_v_H, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":130
 *     cdef double den
 * 
 *     M = H.shape[0]             # <<<<<<<<<<<<<<
 *     N = H.shape[1]
 * 
 */
  __pyx_v_M = (((PyArrayObject *)__pyx_v_H)->dimensions[0]);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":131
 * 
 *     M = H.shape[0]
 *     N = H.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_N = (((PyArrayObject *)__pyx_v_H)->dimensions[1]);

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":133
 *     N = H.shape[1]
 * 
 *     hR = np.zeros(M, dtype=np.double)             # <<<<<<<<<<<<<<
 *     for i in range(M):
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_M); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__double); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_3, ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_5, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_hR);
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_hR, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_7 < 0)) {
      PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_hR, (PyObject*)__pyx_v_hR, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_bstride_0_hR = __pyx_bstruct_hR.strides[0];
    __pyx_bshape_0_hR = __pyx_bstruct_hR.shape[0];
    if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_6 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_v_hR));
  __pyx_v_hR = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":134
 * 
 *     hR = np.zeros(M, dtype=np.double)
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_7; __pyx_t_11+=1) {
    ...
    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":135
 *     hR = np.zeros(M, dtype=np.double)
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             hR[i] += H[i, j]
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":136
 *     for i in range(M):
 *         for j in range(N):
 *             hR[i] += H[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_14 = __pyx_v_i;
      __pyx_t_15 = __pyx_v_j;
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_bshape_0_H;
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_bshape_1_H;
      __pyx_t_16 = __pyx_v_i;
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_bshape_0_hR;
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hR.buf, __pyx_t_16, __pyx_bstride_0_hR) += (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_14, __pyx_bstride_0_H, __pyx_t_15, __pyx_bstride_1_H));
    }
  }

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":138
 *             hR[i] += H[i, j]
 * 
 *     hC = np.zeros(N, dtype=np.double)             # <<<<<<<<<<<<<<
 *     for i in range(M):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromLong(__pyx_v_N); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__double); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyEval_CallObjectWithKeywords(__pyx_t_1, __pyx_t_3, ((PyObject *)__pyx_t_5)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_5)); __pyx_t_5 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_4);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_hC);
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_hC, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_7 < 0)) {
      PyErr_Fetch(&__pyx_t_10, &__pyx_t_9, &__pyx_t_8);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_hC, (PyObject*)__pyx_v_hC, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_bstride_0_hC = __pyx_bstruct_hC.strides[0];
    __pyx_bshape_0_hC = __pyx_bstruct_hC.shape[0];
    if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_6 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_v_hC));
  __pyx_v_hC = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":139
 * 
 *     hC = np.zeros(N, dtype=np.double)
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_7; __pyx_t_11+=1) {
    ...
    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":140
 *     hC = np.zeros(N, dtype=np.double)
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             hC[j] += H[i, j]
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":141
 *     for i in range(M):
 *         for j in range(N):
 *             hC[j] += H[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_bshape_0_H;
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_bshape_1_H;
      __pyx_t_19 = __pyx_v_j;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_bshape_0_hC;
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hC.buf, __pyx_t_19, __pyx_bstride_0_hC) += (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_17, __pyx_bstride_0_H, __pyx_t_18, __pyx_bstride_1_H));
    }
  }

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":143
 *             hC[j] += H[i, j]
 * 
 *     S = 0             # <<<<<<<<<<<<<<
 *     for i in range(M):
 ...
 */
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":144
 * 
 *     S = 0
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_7; __pyx_t_11+=1) {
    ...
    /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":145
 *     S = 0
 *     for i in range(M):
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             if H[i, j] == 0 or hR[i] == 0 or hC[j] == 0:
 ...
 */
    ...
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":146
 *     for i in range(M):
 *         for j in range(N):
 *             if H[i, j] == 0 or hR[i] == 0 or hC[j] == 0:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_bshape_0_H;
      if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_bshape_1_H;
      if (!((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_20, __pyx_bstride_0_H, __pyx_t_21, __pyx_bstride_1_H)) == 0)) {
        __pyx_t_22 = __pyx_v_i;
        if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_bshape_0_hR;
        if (!((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hR.buf, __pyx_t_22, __pyx_bstride_0_hR)) == 0)) {
          __pyx_t_23 = __pyx_v_j;
          if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_bshape_0_hC;
          __pyx_t_24 = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hC.buf, __pyx_t_23, __pyx_bstride_0_hC)) == 0);
        } else {
          __pyx_t_24 = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hR.buf, __pyx_t_22, __pyx_bstride_0_hR)) == 0);
        }
        __pyx_t_25 = __pyx_t_24;
      } else {
        __pyx_t_25 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_20, __pyx_bstride_0_H, __pyx_t_21, __pyx_bstride_1_H)) == 0);
      }
      if (__pyx_t_25) {

        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":147
 *         for j in range(N):
 *             if H[i, j] == 0 or hR[i] == 0 or hC[j] == 0:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":149
 *                 continue
 * 
 *             den = (hR[i] * hC[j])             # <<<<<<<<<<<<<<
 *             if den == 0:
 ...
 */
      ...
      if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_bshape_0_hR;
      __pyx_t_27 = __pyx_v_j;
      if (__pyx_t_27 < 0) __pyx_t_27 += __pyx_bshape_0_hC;
      __pyx_v_den = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hR.buf, __pyx_t_26, __pyx_bstride_0_hR)) * (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_double_t *, __pyx_bstruct_hC.buf, __pyx_t_27, __pyx_bstride_0_hC)));

      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":150
 * 
 *             den = (hR[i] * hC[j])
 *             if den == 0:             # <<<<<<<<<<<<<<
 *                 S += 100
 *                 continue
 */
      __pyx_t_25 = (__pyx_v_den == 0);
      if (__pyx_t_25) {

        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":151
 *             den = (hR[i] * hC[j])
 *             if den == 0:
 *                 S += 100             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
        ...
        /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":152
 *             if den == 0:
 *                 S += 100
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":154
 *                 continue
 * 
 *             S += H[i, j] * logf(H[i, j] / den) / logf(2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_bshape_0_H;
      if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_bshape_1_H;
      __pyx_t_30 = __pyx_v_i;
      __pyx_t_31 = __pyx_v_j;
      if (__pyx_t_30 < 0) __pyx_t_30 += __pyx_bshape_0_H;
      if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_bshape_1_H;
      __pyx_t_32 = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_30, __pyx_bstride_0_H, __pyx_t_31, __pyx_bstride_1_H));
      if (unlikely(__pyx_v_den == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_t_33 = ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_bstruct_H.buf, __pyx_t_28, __pyx_bstride_0_H, __pyx_t_29, __pyx_bstride_1_H)) * logf((__pyx_t_32 / __pyx_v_den)));
      __pyx_t_34 = logf(2);
      if (unlikely(__pyx_t_34 == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_S += (__pyx_t_33 / __pyx_t_34);
      __pyx_L15_continue:;
    }
  }

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":162
 * ##     S = -np.sum(H[mask] * np.log(h[mask])) / np.log(2)
 * 
 *     return S             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = PyFloat_FromDouble(__pyx_v_S); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 162; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_hC);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("supreme.register.parzen.mutual_info");
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_H);
 ...
 */
    ...
    PyTuple_SET_ITEM(__pyx_t_2, 0, ((PyObject *)__pyx_kp_u_3));
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyObject_RichCompare(__pyx_t_2, ((PyObject *)__pyx_kp_s_5), Py_EQ); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 216; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_2 = PyObject_RichCompare(__pyx_t_3, ((PyObject *)__pyx_kp_s_6), Py_EQ); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 217; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      ...
      PyTuple_SET_ITEM(__pyx_t_2, 0, ((PyObject *)__pyx_kp_u_7));
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_2 = PyNumber_Remainder(((PyObject *)__pyx_kp_u_8), __pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 237; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = PyObject_RichCompare(__pyx_t_3, ((PyObject *)__pyx_kp_s_5), Py_EQ); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 737; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_3 = PyObject_RichCompare(__pyx_t_5, ((PyObject *)__pyx_kp_s_6), Py_EQ); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 738; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *         else:
 */
        __pyx_t_3 = PyNumber_Remainder(((PyObject *)__pyx_kp_u_8), __pyx_v_t); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 780; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("joint_hist"), (PyCFunction)__pyx_pf_7supreme_8register_6parzen_joint_hist, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7supreme_8register_6parzen_joint_hist)},
  {__Pyx_NAMESTR("mutual_info"), (PyCFunction)__pyx_pf_7supreme_8register_6parzen_mutual_info, METH_O, __Pyx_DOCSTR(__pyx_doc_7supreme_8register_6parzen_mutual_info)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__joint_hist, __pyx_k__joint_hist, sizeof(__pyx_k__joint_hist), 0, 0, 1, 1},
  {&__pyx_n_s__mutual_info, __pyx_k__mutual_info, sizeof(__pyx_k__mutual_info), 0, 0, 1, 1},
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_IndexError = __Pyx_GetName(__pyx_b, __pyx_n_s__IndexError); if (!__pyx_builtin_IndexError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initparzen(void); /*proto*/
PyMODINIT_FUNC initparzen(void)
#else
PyMODINIT_FUNC PyInit_parzen(void); /*proto*/
PyMODINIT_FUNC PyInit_parzen(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  __pyx_refchk = __Pyx_Refnanny->NewContext("PyMODINIT_FUNC PyInit_parzen(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("parzen"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_11), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_supreme__register__parzen) {
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":6
 * 
 * """
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":10
 * cimport cython
 * 
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_1, 0, ((PyObject *)__pyx_n_s__gauss));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__gauss));
  __pyx_t_2 = __Pyx_Import(((PyObject *)__pyx_n_s_12), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__gauss); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__gauss, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":42
 * @cython.boundscheck(False)
 * def joint_hist(np.ndarray[np.uint8_t, ndim=2] A,
 *                np.ndarray[np.uint8_t, ndim=2] B, L=255, win_size=5, std=1.0,             # <<<<<<<<<<<<<<
 *                int fast=0):
 ...
 */
  __pyx_t_2 = PyFloat_FromDouble(1.0); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_k_1 = __pyx_t_2;
  __Pyx_GIVEREF(__pyx_t_2);
  __pyx_t_2 = 0;

  /* "/home/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":1
 * # -*- python -*-             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = PyObject_GetAttr(__pyx_m, __pyx_n_s__joint_hist); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_m, __pyx_n_s__mutual_info); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init supreme.register.parzen");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init supreme.register.parzen");
  }
  __pyx_L0:;
  __Pyx_FinishRefcountContext();
  #if PY_MAJOR_VERSION < 3
