/* Generated by Cython 0.11.3 on Mon Apr  5 02:42:32 2010 */
...
static  PyArrayObject *__pyx_f_7supreme_8register_6parzen__add_window(PyArrayObject *__pyx_v_out_arr, int __pyx_v_m, int __pyx_v_n, PyArrayObject *__pyx_v_win_arr) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":19
 * cdef np.ndarray _add_window(np.ndarray out_arr, int m, int n,
 *                             np.ndarray win_arr):
 *     cdef np.ndarray[np.double_t, ndim=2] out = out_arr             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":22
 *     cdef np.ndarray[np.double_t, ndim=2] w = win_arr
 * 
 *     cdef int hwin = (win_arr.shape[0] - 1)/2             # <<<<<<<<<<<<<<
 *     cdef int i, j, ii, jj
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":25
 *     cdef int i, j, ii, jj
 *     cdef int M, N
 *     M = out_arr.shape[0]             # <<<<<<<<<<<<<<
 *     N = out_arr.shape[1]
 ...
 */
    ...
    for (__pyx_t_4 = (-__pyx_v_hwin); __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":30
 *     for i in range(-hwin, hwin + 1):
 *         for j in range(-hwin, hwin + 1):
 *             ii = i + m             # <<<<<<<<<<<<<<
 *             jj = j + n
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":33
 *             jj = j + n
 * 
 *             if (ii < 0) or (ii >= M) or (jj < 0) or (jj >= N):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":38
 *             out[ii, jj] += w[i + hwin, j + hwin]
 * 
 *     return out             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_7supreme_8register_6parzen_joint_hist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":73
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":74
 * 
 *     if not (A.shape[0] == B.shape[0]) and (A.shape[1] == B.shape[1]):
 *         raise IndexError("Shapes of both input arrays must be equal.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":82
 *         w = gauss(win_size, std)
 * 
 *     out = np.zeros((L, L), dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":85
 * 
 *     cdef int m, n, i, j, a, b
 *     m = A.shape[0]             # <<<<<<<<<<<<<<
 *     n = A.shape[1]
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":88
 *     n = A.shape[1]
 * 
 *     for i in range(m):             # <<<<<<<<<<<<<<
 *         for j in range(n):
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":93
 *             b = B[i, j]
 * 
 *             if fast:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":131
 * 
 *     M = H.shape[0]
 *     N = H.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_25) {
        ...
        /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":151
 *             den = (hR[i] * hC[j])
 *             if den == 0:
 *                 S += 100             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":154
 *                 continue
 * 
 *             S += H[i, j] * logf(H[i, j] / den) / logf(2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":162
...
#endif
{
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":6
 * 
 * """
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":10
 * cimport cython
 * 
 ...
 */
  ...
  /* "/Users/stefan/akad/projekte/supreme/supreme/register/parzen.pyx":42
 * @cython.boundscheck(False)
 * def joint_hist(np.ndarray[np.uint8_t, ndim=2] A,
 *                np.ndarray[np.uint8_t, ndim=2] B, L=255, win_size=5, std=1.0,             # <<<<<<<<<<<<<<
 *                int fast=0):
