...
/* Use constant GPC_EPSILON if defined and a variable value if not
   defined! This is a change made by Joerg Raedler and is not part of 
   the official gpc package! */
#ifndef GPC_EPSILON
